        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    approval_status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "PENDING"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_bus_operators_approval_status", "approval_status IN ('PENDING','APPROVED','REJECTED')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_bookings_status", "status IN ('PENDING','CONFIRMED','FAILED','CANCELLED','EXPIRED')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    bus_schedule_id = table.Column<int>(type: "integer", nullable: false),
                    ...
                    hold_expiry = table.Column<DateTime>(type: "timestamp", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_seat_availabilities", x => x.id);
                    table.CheckConstraint("ck_seat_availabilities_status", "status IN ('Available','Held','Booked')");
                    table.ForeignKey(
                        name: "FK_seat_availabilities_bus_schedules_bus_schedule_id",
                        column: x => x.bus_schedule_id,
                        principalTable: "bus_schedules",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_seat_availabilities_seats_seat_id",
                        column: x => x.seat_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    gateway_order_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    seat_availability_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_booking_passengers_seat_availabilities_seat_availability_id",
                        column: x => x.seat_availability_id,
                        principalTable: "seat_availabilities",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_booking_passengers_seat_availability_id",
                table: "booking_passengers",
                column: "seat_availability_id");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_seat_availability_schedule",
                table: "seat_availabilities",
                column: "bus_schedule_id");

            migrationBuilder.CreateIndex(
                name: "IX_seat_availabilities_bus_schedule_id_seat_id",
                table: "seat_availabilities",
                columns: new[] { "bus_schedule_id", "seat_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_seat_availabilities_seat_id",
                table: "seat_availabilities",
                column: "seat_id");
