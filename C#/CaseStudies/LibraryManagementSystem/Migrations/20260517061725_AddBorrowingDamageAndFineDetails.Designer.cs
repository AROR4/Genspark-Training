...
namespace LibraryManagementSystem.Migrations
{
    ...
    [Migration("20260517061725_AddBorrowingDamageAndFineDetails")]
    partial class AddBorrowingDamageAndFineDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.BookCopy", b =>
                {
                    ...
                    b.ToTable("BookCopies", t =>
                        {
                            t.HasCheckConstraint("CK_BookCopies_DamagePercentage", "\"DamagePercentage\" >= 0 AND \"DamagePercentage\" <= 100");

                            t.HasCheckConstraint("CK_BookCopies_Status", "\"Status\" IN ('Available', 'Borrowed', 'Lost')");
                        });
                });
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.Borrowing", b =>
                {
                    ...
                    b.Property<int?>("NewDamagePercentage")
                        .HasColumnType("integer");

                    b.Property<int>("OldDamagePercentage")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Borrowings", t =>
                        {
                            t.HasCheckConstraint("CK_Borrowings_NewDamagePercentage", "\"NewDamagePercentage\" IS NULL OR (\"NewDamagePercentage\" >= 0 AND \"NewDamagePercentage\" <= 100)");

                            t.HasCheckConstraint("CK_Borrowings_OldDamagePercentage", "\"OldDamagePercentage\" >= 0 AND \"OldDamagePercentage\" <= 100");
